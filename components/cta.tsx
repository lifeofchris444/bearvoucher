...
import { ArrowRight, Gift, Sparkles, PawPrint } from "lucide-react";
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-10 pb-14 sm:pt-14 sm:pb-18 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#0156A2] rounded-3xl p-7 sm:p-10 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Join thousands of shoppers who have already claimed their $250 reward. Your perfect gift is just a few clicks away.
            </p>
            ...
            >
              <a
                href="https://trksy.org/aff_c?offer_id=4664&aff_id=26188"
                target="_blank"
                rel="noopener noreferrer"
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#0156A2] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/95 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
