  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#0156A2] font-semibold">Build-A-Bear</span>{" "}
        ...
        >
          Discover how people are creating personalized gifts, plush companions, collectibles, and memorable experiences.
        </p>
        ...
        >
          <a
            ...
            className="touch-button group inline-flex items-center gap-3 bg-[#0156A2] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#013f78] transition-all duration-300 hover:shadow-xl hover:shadow-[#0156A2]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
